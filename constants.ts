...
export const translations: Translations = {
    en: {
        ...
        startSearching: "Let us seek wisdom together.",
        footerHome: "Home",
        footerInput: "Input",
        footerQuote: "Quote",
        ...
        noReflectionsMessage: "My dear friend, you haven't penned any reflections yet. I encourage you to find a passage that deeply resonates with your heart and inscribe your precious thoughts. This journal is for your growth, your victory.",
        ...
        searchTitle: "Find Guidance",
        searchSubtitle: "Enter a theme or feeling to discover relevant wisdom from The New Human Revolution.",
        searchInputPlaceholder: "e.g., courage, hope, perseverance...",
        clearInput: "Clear",
    ...
    ja: {
        ...
        startSearching: "さあ、智慧を求める旅に出ましょう",
        footerHome: "ホーム",
        footerInput: "入力",
        footerQuote: "引用",
        ...
        noReflectionsMessage: "親愛なる友よ、まだ何の感想も記されていませんね。心に響く一節を見つけ、あなたの尊い思いを書き留めてみませんか。このジャーナルは、あなたの成長と勝利のためにあるのです。",
        ...
        backToSearch: "検索に戻る",
        searchTitle: "指導を探す",
        searchSubtitle: "テーマや気持ちを入力して、新・人間革命から関連する知恵を発見しましょう。",
        searchInputPlaceholder: "例：勇気、希望、忍耐...",
        clearInput: "クリア",
